...
const galleryEl = (0, _galleryItemsJs.galleryItems).map(({ preview , description , original  })=>`<a class="gallery__item" href="${original}">
            <img class="gallery__image" src="${preview}" alt="${description}" />
        </a>`).join("");
galleryMarkUp.insertAdjacentHTML("beforeend", galleryEl);
new (0, _simplelightboxDefault.default)(".gallery__item", {
    captionDelay: 250
});
